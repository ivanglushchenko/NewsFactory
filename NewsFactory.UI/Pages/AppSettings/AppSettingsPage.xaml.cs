...
namespace NewsFactory.UI.Pages.AppSettings
{
    ...
    /// </summary>
    public sealed partial class AppSettingsPage : NewsFactory.UI.Common.LayoutAwarePage
    {
        #region .ctors
        ...
        public AppSettingsPage()
        {
            ...
            DataContext = new AppSettingsPageModel();
        }
        ...
        private AppSettingsPageModel Model { get { return (AppSettingsPageModel)DataContext; } }

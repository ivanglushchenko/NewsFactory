...
namespace NewsFactory.Foundation.Common
{
    ...
    public class LayoutAwarePage : Page
    {
        ...
        public Action GoBackCommand { get; private set; }

        public virtual void SetBackCommand(Action action)
        {
            GoBackCommand = action;
        }
        ...
        public LayoutAwarePage()
        {
            ...
            this.Unloaded += (sender, e) =>
            {
                ...
                Window.Current.CoreWindow.PointerPressed -=
                    this.CoreWindow_PointerPressed;
                var disp = DataContext as IDisposable;
                if (disp != null)
                    disp.Dispose();
            };
        }
        ...
        protected virtual void GoBack(object sender, RoutedEventArgs e)
        {
            ...
            if (GoBackCommand != null) GoBackCommand();
        }
